...
import 'package:movies_app/features/movies/presentation/widgets/now_playing_component%20(2).dart';
...
class MainMoviesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (BuildContext context) => sl<MovieBloc>()
